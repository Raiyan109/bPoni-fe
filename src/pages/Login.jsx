...
const Login = () => {
    ...
    return (
        <div style={{ backgroundImage: `url("${bg}")` }} className=" w-full bg-no-repeat bg-center bg-cover ">
            <div className="flex justify-center items-center mx-auto h-screen inset-0 bg-white bg-opacity-30">
                    ...
                    <form>
                        <div className="flex justify-center items-center flex-col space-y-3">
                            ...
                            <input type="search" name="Search" placeholder="Email"
                                ...
                                className="w-56 py-3 lg:py-3 px-5 text-lg rounded-2xl focus:outline-none border-gray-400 border-2 text-left" autoComplete="off" />
                            <input type="search" name="Search" placeholder="Password"
                                value={password}
                                onChange={(e) => setPassword(e.target.value)}
                                className="w-56 py-3 lg:py-3 px-5 text-xl rounded-2xl focus:outline-none border-gray-400 border-2 text-left" autoComplete="off" />
                            {/* Button */}
